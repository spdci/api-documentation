...
$.getJSON('./assets/example_files/crvsusecase.json', function(data) {
    ...
    $.each(data, function(index, val) {
        ...
        var usecaseDiv = '<div class="col-sm-12 mainusecasediv">'+
            ' <div class="card">'+
                '     <div class="card-header collapsed " id="collapseCardheader'+usecaseid+'" data-toggle="collapse" data-target="#collapseCardBody'+usecaseid+'" aria-expanded="false" aria-controls="collapseCardBody'+usecaseid+'">'+
                    ...
                    '</span></div>'+
                    '  <div id="collapseCardBody'+usecaseid+'" class="collapse ">'+
                        '     <div class="card-body">'+
                            '  <div class="row">'+
                                '      <div class="col-sm-6"> '+
        ...
        // Remove the leading # symbol from the hash
        ...
        $('html, body').animate({
        scrollTop: $("#collapseCardheader"+value).offset().top
    }, 2000);
